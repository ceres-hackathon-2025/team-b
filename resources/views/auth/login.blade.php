        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form class="space-y-4 md:space-y-6" method="POST" action="/login">
                ...
                <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                    アカウントをお持ちでない場合
                    <a href="{{ route('signup') }}" class="font-medium text-green-600 hover:text-green-700 hover:underline dark:text-green-400 dark:hover:text-green-300">
                        こちらから登録
                    </a>
                </p>
            </form>
