        ...
        <footer>
            <div
                ...
                <div class="grid h-full max-w-lg grid-cols-3 mx-auto">
                    <a href="{{ route('posts.show', 1) }}" data-tooltip-target="tooltip-home" type="button"
                    ...
                    <div class="flex items-center justify-center">
                        <a href="{{ route('posts.create') }}" data-tooltip-target="tooltip-new" type="button"
                            class="inline-flex items-center justify-center w-10 h-10 font-medium bg-green-600 rounded-full hover:bg-green-700 group focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-blue-800">
                    ...
                    <a href="{{ route('profile.show', isset($user) ? $user->id : (Auth::check() ? Auth::user()->id : '')) }}"
                        ...
                        <svg class="w-5 h-5 mb-1 text-gray-500 dark:text-gray-400 group-hover:text-green-600 dark:group-hover:text-green-500"
                            aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            viewBox="0 0 20 20">
                            <path
